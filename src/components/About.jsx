    ...
    <Container className="py-16">
      <div className="flex flex-col lg:flex-row items-start justify-between gap-10">
        ...
        <div className="flex flex-col gap-8 max-w-xl items-center lg:items-start">
          <h2 className="text-3xl md:text-4xl font-bold title text-primary mb-4 text-center lg:text-left font-[Helvetica]">À propos de nous</h2>
          <div className="flex flex-col gap-4y w-full">
            <div className="flex items-center gap-3 justify-center lg:justify-start">
              <GraduationCap className="text-secondary w-15 h-15" />
              <h3 className="text-xl font-semibold text-primary font-[Helvetica]">+3 ans</h3>
            </div>
            <p className="text-gray-700 mb-5 text-center lg:text-left font-[Helvetica]">
            ...
            <div className="flex items-center gap-3 justify-center lg:justify-start">
              ...
              <h3 className="text-xl font-semibold text-primary font-[Helvetica]">+250 étudiants</h3>
            </div>
            <p className="text-gray-700 mb-5 text-center lg:text-left font-[Helvetica]">
            ...
            <div className="flex items-center gap-3 justify-center lg:justify-start">
              ...
              <h3 className="text-xl font-semibold text-primary font-[Helvetica]">Notre mission</h3>
            </div>
            <p className="text-gray-700 mb-5 text-center lg:text-left font-[Helvetica]">

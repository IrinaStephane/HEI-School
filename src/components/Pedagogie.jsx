    ...
    <div className="bg-white w-full py-16">
      <Container>
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-0">
          {/* Bloc image + fond */}
          <div className="relative w-full max-w-120 min-w-80 h-92.5 flex-shrink-0 mb-8 lg:mb-0">
            <img
          ...
          <div className="flex-1 flex flex-col items-start justify-center max-w-xl">
            <h2 className="text-primary text-5xl font-serif font-bold mb-6 text-left title">Le programme pédagogique</h2>
            <p className="text-primary text-lg mb-8 text-left font-[Helvetica]">
            ...
            <button className="px-8 font-[Helvetica] py-3 border-2 border-primary text-primary text-lg font-bold rounded bg-white hover:bg-primary hover:text-white transition">
              Notre Programme
            </button>
          </div>
        </div>
      ...
      <Container className="mt-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <div className="bg-[#FAF0D6] rounded-xl flex flex-col items-start justify-center px-7 py-7 min-h-[140px] md:min-h-[240px]">
            <span className="text-secondary text-3xl md:text-5xl font-semibold mb-6 font-[Helvetica]">25%</span>
            <span className="text-primary text-lg md:text-2xl font-semibold leading-tight font-[Helvetica]">
